...
public class MenuTestData {
    ...
    public static final int MENU_6_ID = 7;
    public static final int MENU_CREATED_ID = 8;
    ...
    public static final MenuTO menu_1 = new MenuTO(Set.of(DISH_1, DISH_2));
    public static final MenuTO menu_1_2 = new MenuTO(Set.of(DISH_7));
    public static final MenuTO menu_2 = new MenuTO(Set.of(DISH_3, DISH_4));
    public static final MenuTO menu_3 = new MenuTO(Set.of(DISH_5, DISH_6));
    public static final MenuTO menu_4 = new MenuTO(Set.of(DISH_9));
    public static final MenuTO menu_created = new MenuTO(Set.of(NEW_DISH_1));

    public static MenuTO getNew() {
        return new MenuTO(Set.of(NEW_DISH_1));
    }

    public static MenuTO getUpdated() {
        return new MenuTO(Set.of(DISH_1, NEW_DISH_1));
    }
}
