...
import static ru.javaops.restaurants.restaurant.DishTestData.*;
...
public class MenuTestData {
    ...
    public static final MenuTO menu_4 = new MenuTO(MENU_5_ID, LocalDate.now(), Set.of(DISH_9));
    public static final MenuTO menu_created = new MenuTO(MENU_CREATED_ID, NEW_MENU_DATE, Set.of(NEW_DISH_1));
