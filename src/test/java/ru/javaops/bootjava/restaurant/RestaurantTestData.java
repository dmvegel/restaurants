...
public class RestaurantTestData {
    ...
    public static final int DISABLED_RESTAURANT_ID = 4;
    public static final int RESTAURANT_5_ID = 5;
    ...
    public static final AdminRestaurantTO admin_restaurant_1 = new AdminRestaurantTO(RESTAURANT_1_ID, "Italian Bistro", true);
    public static final AdminRestaurantTO admin_restaurant_2 = new AdminRestaurantTO(RESTAURANT_2_ID, "Sushi Place", true);
    public static final AdminRestaurantTO admin_restaurant_3 = new AdminRestaurantTO(RESTAURANT_3_ID, "Burger House", true);
    public static final AdminRestaurantTO admin_restaurant_created = new AdminRestaurantTO(RESTAURANT_5_ID, "New Restaurant", true);
    public static final AdminRestaurantTO admin_restaurant_updated = new AdminRestaurantTO(RESTAURANT_1_ID, "UpdatedName", true);
    public static final AdminRestaurantTO admin_disabled_restaurant = new AdminRestaurantTO(DISABLED_RESTAURANT_ID, "Disabled Restaurant", false);
