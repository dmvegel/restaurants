...
import ru.javaops.bootjava.restaurant.MenuTestData;
...
import static ru.javaops.bootjava.restaurant.RestaurantTestData.RESTAURANT_NOT_FOUND_ID;
import static ru.javaops.bootjava.restaurant.web.AdminMenuController.REST_URL;
...
class AdminMenuControllerTest extends AbstractControllerTest {
    ...
    void getAll() throws Exception {
        perform(MockMvcRequestBuilders.get(REST_URL_FOR_ID_1))
                .andExpect(status().isOk())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
                .andExpect(MENU_TO_MATCHER.contentJson(menu_1, menu_1_2));
    }
